  ...
  <div class="panel">
    ...
    <div class="panel-body">
      <div>
        ...
        <table-data :tableData="table_data" :loadData="load_data" @save="get_table_data" @upDate="upDate" @upload="upload"></table-data>
      </div>
      <bottom-tool-bar>
        <div slot="page">
          <el-pagination
  ...
  methods: {
    getDetail() {
      ...
      if (this.$route.query.Edition == "离线版本") {
        url = "/cloth/selectEdiloCloOutDetail";
      } else {
        url = "/cloth/selectEdiCloDetail";
      }
      this.$http({
        url: url,
        method: "POST",
