  ...
  <div class="panel">
    ...
    <div class="panel-body">
    	<div>
	        ...
	        <div class="list">
	        	<el-row>
				  <el-col :span="4"><div class="list-item-1">ID</div></el-col>
				  <el-col :span="8"><div class="list-item-1 list-item-2">{{info.editionId}}</div></el-col>
				  <el-col :span="4"><div class="list-item-1">版本名称</div></el-col>
				  <el-col :span="8"><div class="list-item-1 list-item-2">{{info.editionName}}</div></el-col>
				</el-row>
				<el-row>
				  <el-col :span="4"><div class="list-item-1">日期</div></el-col>
				  <el-col :span="8"><div class="list-item-1 list-item-2">{{$dateFormat(parseInt(info.editionUpdated),"yyyy-MM-dd hh:mm:ss")}}</div></el-col>
				  <el-col :span="4"><div class="list-item-1">版本号</div></el-col>
				  <el-col :span="8"><div class="list-item-1 list-item-2">{{info.editionNum}}</div></el-col>
				</el-row>
				<el-row>
				  <el-col :span="4"><div class="list-item-1">版本描述</div></el-col>
				  <el-col :span="8"><div class="list-item-1 list-item-2">{{info.editionRemark}}</div></el-col>
					<el-col :span="4">
    ...
    methods: {
      getDetail(){
	      	...
	      	if(this.$route.query.Edition == '离线版本'){
	      		url = '/hairdo/selectEdiHaiOutDetail'
	        }else{
	        	url = '/hairdo/selectEdiHaiDetail'
	        }
	        this.$http({
		          url: url,
		          method: 'POST',
